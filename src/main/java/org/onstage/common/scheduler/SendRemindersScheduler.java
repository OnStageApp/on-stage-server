...
public class SendRemindersScheduler {
    ...
    public void sendReminders() {
        ...
        for (Reminder reminder : remindersToSend) {
            ...
            stagers.forEach(stager -> notificationService.sendNotificationToUser(NotificationType.REMINDER, stager.userId(), description, title, event.getTeamId(), NotificationParams.builder().eventId(event.getId()).build()));
