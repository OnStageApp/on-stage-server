...
public class SubscriptionRepository {
    ...
    public Subscription findByOriginalTransactionId(String originalTransactionId) {
        Criteria criteria = Criteria.where(Subscription.Fields.originalTransactionId).is(originalTransactionId);
        return mongoTemplate.findOne(query(criteria), Subscription.class);
    }
}
